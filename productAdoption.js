...
const ProductAdoption = {
    ...
    metricsData: {
        trial: {
            All: { signups: 1250, converted: 210, firstBuy: ["CRM", "Desk"], nextAdoption: ["Projects", "People", "Analytics"] },
            NA:  { signups: 600,  converted: 120, firstBuy: ["CRM", "One"], nextAdoption: ["Projects", "People", "Desk"] },
            EU:  { signups: 400,  converted: 60,  firstBuy: ["Desk", "Mail"], nextAdoption: ["Analytics", "CRM", "SalesIQ"] },
            APAC:{ signups: 250,  converted: 30,  firstBuy: ["Bigin", "CRM"], nextAdoption: ["Social", "Desk", "Mail"] }
        },
        paid: {
            All:        { base: 850, retained: 765, firstBuy: ["CRM", "Desk"], nextAdoption: ["Projects", "People", "Analytics"] },
            Tech:       { base: 350, retained: 335, firstBuy: ["One", "Analytics"], nextAdoption: ["Desk", "Projects", "People"] },
            Retail:     { base: 300, retained: 240, firstBuy: ["CRM", "Bigin"], nextAdoption: ["Inventory", "Books", "Desk"] },
            Healthcare: { base: 200, retained: 190, firstBuy: ["Desk", "People"], nextAdoption: ["Assist", "Vault", "Analytics"] }
        }
    },
...
renderTrialCard: function(regionKey) {
    ...
    // REMOVED: tipHTML logic (Low Conv / High Perf)
...
renderPaidCard: function(industryKey) {
    ...
    // REMOVED: tipHTML logic (Churn Risk / Stable)

    return `
        <div class="pa-segment-insight">
            <div class="pa-card-header">
                <div>
                    <h3 class="text-paid">Paid Users</h3>
